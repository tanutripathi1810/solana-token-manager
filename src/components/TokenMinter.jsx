...
export const TokenMinter = () => {
  const { mintTokens, loading, error } = useTokenContext()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMintSuccess(`Successfully minted ${formData.amount} tokens`)
        ...
        <div style={styles.formGroup}>
          ...
          <div style={styles.inputBox}>
            <input
              ...
              required
            />
            <div style={{...styles.helpText, ...responsiveStyles.helpText}}>The address of the token to mint</div>
          </div>
        </div>
        ...
        <div style={styles.formGroup}>
          ...
          <div style={styles.inputBox}>
            <input
              ...
              required
            />
            <div style={{...styles.helpText, ...responsiveStyles.helpText}}>Number of tokens to mint</div>
          </div>
        </div>
